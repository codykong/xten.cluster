...
package com.xten.cluster.common.unit;


import com.xten.cluster.common.exception.ParseException;
import com.xten.cluster.common.util.StringUtil;
...
public class ByteSizeValue implements Comparable<ByteSizeValue> {
    ...
    public String toString() {
        ...
        return StringUtil.format1Decimals(value, suffix);
    }
    ...
    public static ByteSizeValue parseBytesSizeValue(String sValue, ByteSizeValue defaultValue, String settingName)
        ...
        try {
            ...
            throw new ParseException("failed to parse [{}]", e, sValue);
        }
